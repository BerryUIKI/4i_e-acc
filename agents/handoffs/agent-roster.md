...
**Naming convention**: `{DevicePrefix}-{AgentRole}-{Type}`. Device: `dev-box` (sandbox). Type: `main` or `sub`. All lowercase. Examples: `dev-box-doc-main`, `dev-box-ci-sub`.

---

## Quick-lookup summary

| ShortAgentID   | Type   | Bound Main      | Role         | Name               | Status  |
|----------------|--------|-----------------|--------------|--------------------|---------|
| `305cde212a`   | MAIN   | ROOT            | `doc-writer` | `dev-box-doc-main` | ACTIVE  |
| `8f9b1fd0b6`   | SUB    | `305cde212a`    | `ci-fixer`   | `dev-box-ci-sub`   | ACTIVE  |
...
| Permissions | Decompose goals, dispatch sub-agents via prompts, monitor status files, aggregate outputs, execute git push |
...
| ShortAgentID | Role | Name | Status | Device FP | Registered (UTC ms) |
|---|---|---|---|---|---|
| `8f9b1fd0b6` | `ci-fixer` | `dev-box-ci-sub` | ACTIVE | `0101aaa313a11c56` | `1785306926859` |
